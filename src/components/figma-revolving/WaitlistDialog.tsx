        ...
        <div className={cn("flex flex-col", PANEL_W)}>
          {!emailFieldActive ? (
            <button
              type="button"
              className={cn(
                "flex min-h-14 w-full cursor-text items-center justify-center rounded-none border-0 px-3 text-center outline-none transition-colors",
                "focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background",
                idleSlide === 0 &&
                  "bg-white text-base font-medium tracking-wide text-neutral-500 uppercase hover:bg-neutral-50 dark:bg-white! dark:text-neutral-500",
                idleSlide === 1 &&
                  "bg-black text-sm font-semibold tracking-wide text-white uppercase hover:bg-black/90 dark:bg-black",
                idleSlide === 2 &&
                  "bg-white text-sm font-medium uppercase leading-snug tracking-wide text-neutral-800 dark:bg-white! dark:text-neutral-800",
              )}
            ...
            <div className="relative">
              <Input
                ...
                className={cn(
                  "h-14 rounded-none border-0 bg-white pr-12 text-center text-base font-medium tracking-wide text-neutral-900 normal-case shadow-none",
                  "placeholder:text-neutral-500 placeholder:uppercase placeholder:tracking-wide",
                  "focus-visible:border-0 focus-visible:ring-2 focus-visible:ring-ring/40 focus-visible:ring-offset-0",
