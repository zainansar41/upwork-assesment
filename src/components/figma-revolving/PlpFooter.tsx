    ...
    <div className={cn("flex flex-col gap-4", className)}>
      ...
      <div className="w-full rounded-xl bg-white/10">
        <Input
          ...
          className="h-10 rounded-xl border-0 bg-transparent px-4 text-[12px] text-white shadow-none placeholder:text-white/60 focus-visible:border-0 focus-visible:ring-0 md:h-[34px]"
        />
      </div>
    </div>
  )
